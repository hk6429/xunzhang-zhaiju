...
- [x] 版本庫機密掃描通過。
- [x] iPhone Simulator 完成 82 unit＋8 項適用 UI tests；包含守護神任務卡、學習目標、關卡與奇遇研墨答題、十章被動法寶閣、隱藏真結局、系統無障礙稽核、最大字級與「終止程序後強制離線重開」進度保存。
- [x] iPad 11／13 吋 Simulator 完成 82 unit＋9 UI tests；包含守護神任務卡、學習目標、關卡與奇遇研墨答題、十章被動法寶閣、隱藏真結局、直向、橫向、最大字級、系統無障礙稽核與離線重開保存。
