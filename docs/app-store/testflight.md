...
| 平台 | 必測情境 | 目前證據 |
|---|---|---|
| iPhone | 啟動、四個主區、單調時鐘倒數、最佳完成時間、分鐘級間隔複習、十章被動法寶、隱藏結局、動態文字 | 97 unit＋8 項適用 UI tests 通過；GitHub Xcode 16.4 乾淨 runner 會重跑 |
| iPad | 直向、橫向、單調時鐘倒數、最佳完成時間、分鐘級間隔複習、十章被動法寶、隱藏結局、Split View、鍵盤／觸控 | 11／13 吋本機完成 97 unit＋9 UI；GitHub 11 吋 runner 會重跑，Split View 與觸控真機待驗 |
