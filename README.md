...
每次推送與 pull request 都會執行 GitHub Actions `Quality`：驗證 Web 內容與 109 項契約、Worker typecheck／測試／dry-run、iPhone／iPad UI、App Store 素材，以及未簽署 Release Archive 的版本、圖示、隱私清單與 Debug 開關隔離。
